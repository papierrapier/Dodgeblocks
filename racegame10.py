...
def game_intro(): #runs once, applies well to adding menus (controls, volume) in PauseScreen, etc
    ...
    while intro:
        ...
        textRect.center = ( (150+(100/2)), (450+(50/2)) ) #center on x first (x + xwidth / 2)
        ...
        #**make sure to not do this, for example, this part is repeated. In the future, should be defined in the beginning and referenced instead.
        smallText = pygame.font.Font("freesansbold.ttf",20)
