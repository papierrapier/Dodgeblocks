...
def button(msg,x,y,w,h,ic,ac): #button message(msg), param locations(x,y), width(w), height(h), inactive color(ic), active color(ac)
...
def game_intro(): #runs once, applies well to adding menus (controls, volume) in PauseScreen, etc
    ...
    while intro:
        ...
        button("GO!",150,450,100,50,green,bright_green) #remember, x,y,w,h,ic,ac
        button("Quit?",550,450,100,50,red,bright_red) #yay, reusing functions!
